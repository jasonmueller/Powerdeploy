...
function Get-ExecutionTime
{
    ...
    End
    {
        Get-History @PSBoundParameters | Foreach {
            ...
            $obj | Add-Member NoteProperty Id ($_.Id) -TypeName Pscx.Commands.Modules.Utility.ExecutionTimeInfo
            $obj | Add-Member NoteProperty ExecutionTime ($_.EndExecutionTime - $_.StartExecutionTime)
            $obj | Add-Member NoteProperty HistoryInfo ($_)
            $obj
        }
    }
}
