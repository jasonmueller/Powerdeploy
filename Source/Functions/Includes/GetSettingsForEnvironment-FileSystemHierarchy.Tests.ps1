...
#         Context 'given a settings folder exists with a settings for global environments' {
...
#     Context 'given an environments folder with a global environment settings file' {
